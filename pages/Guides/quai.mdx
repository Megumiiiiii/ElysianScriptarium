...
- isi bagian `ZONE_0_0_COINBASE` sampai `ZONE_2_2_COINBASE`, setiap bagian harus berbeda. Jadi buatlah 0 wallet dan beri nama 0_0 sampai 2_2 agar mudah diingat
